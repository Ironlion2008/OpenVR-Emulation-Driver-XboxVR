...
vr::EVRInitError OpenVREmulatorDriver::VRDriver::Init(vr::IVRDriverContext *pDriverContext)
{
    ...
    // XboxVR hand controllers are supplied by HIDMaestro's modern SteamVR
    // virtual-hand driver. Keep this driver responsible for the HMD and
    // emulation environment, but do not register a second pair of hands.
    Log("[XboxVR][S2] ControllerDevice registration disabled; HIDMaestro owns both SteamVR hands");
